        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '16px' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 6 }}>
              ...
              {address && (
                <button type="button" onClick={handleCopy} aria-label="Copy address" style={{ flexShrink: 0, padding: 6, background: 'none', border: 'none', cursor: 'pointer' }}>
                  <IonIcon icon={copyOutline} style={{ fontSize: 28 }} />
                </button>
              )}
            </div>
            {hoursLabel && (
